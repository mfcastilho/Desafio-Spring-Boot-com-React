      ...
      <form className="form-register user-panel-box">
        <div className="w-75 mx-auto">
          ...
          <div className="mb-3">
            ...
            <input type="number" className="form-control" name="accountNumber" value={accounNumber} id="accountNumber" placeholder="Insira a conta que deseja fazer a tranferência" onChange={(e) => { setAccountNumber(e.target.value) }} />
            <div>
