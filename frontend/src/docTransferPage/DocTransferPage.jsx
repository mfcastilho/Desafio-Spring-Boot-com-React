...
const DocTransferPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(url_base + "/conta/transferencias/doc", data);
    ...
    <div className="container">
      <form onSubmit={handleSubmit} className="form-register user-panel-box">
        <div className="w-75 mx-auto">
          ...
          <button type="submit" className="btn btn-primary w-100" onClick={docFormularyValidation}>Transferir</button>
